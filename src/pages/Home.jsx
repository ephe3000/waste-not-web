...
const Home = () => {
  ...
  return (
    <>
      <Banner />
      <main className="flex flex-col bg-white max-w-lg mx-auto justify-center items-center  md:p-5 my-5 mb-20 rounded-lg shadow-2xl">
        <section>
          ...
          <section className="m-50">
            <div className="pt-3 rounded bg-grey-100">
              <p className="text-gray-700 pt-2 p-2 text-lg text-center">
                Waste-Not is a site for sharing food. Whether you have food to
                spare or are looking for food in your local area, Waste Not can
                help you.
              </p>
